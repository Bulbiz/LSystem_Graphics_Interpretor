...
let systems_suite =
  ...
  >::: [ (*
       ...
       ; (*
            ...
            Systems.next_state tests related.

        *)
         ("Systems.next_state should return the right word with a valid basic system."
         >:: fun _ ->
         ...
         assert_equal expected_word actual_word)
       ; ("Systems.next_state should return the right word with a system that contains a \
           seq inside a branch."
         >:: fun _ ->
       ...
       ; ("Systems.next_state should return the right word with a system that contains a \
         ...
         in
         assert_equal expected_word actual_word)
       ; ("Systems.next_state should return the right word empty."
         >:: fun _ ->
